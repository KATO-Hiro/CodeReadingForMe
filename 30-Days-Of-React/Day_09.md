# 30 Days of React、Day 9: Conditional Rendering

## Conditional Rendering

+ 異なる条件でJSXやコンポーネントを表示する方法
+ 通常のif - else、三項演算子、&&を使って実装する
  + 純粋なJSのconditional statementとは異なる
...
class App extends React.Component {
  ...
  render() {
    ...
    // 条件分岐(ログインしているかどうか)で、表示する内容を変えている
